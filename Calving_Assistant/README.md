...
Create a service module at `livestock/services/ai_service.py` (or `Calving_Assistant/services/ai_service.py`) responsible for:
...
```
.venv\Scripts\python manage.py test Calving_Assistant
```
